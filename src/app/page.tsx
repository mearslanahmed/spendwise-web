    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative pt-24 pb-20 md:pt-32 md:pb-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          {/* Hero Phone Mockup */}
          <div className="relative mx-auto w-full max-w-[320px] lg:max-w-[380px] animate-in fade-in zoom-in-95 duration-1000">
            {/* Phone Frame */}
            ...
            {/* Floating Elements */}
            <div className="absolute -right-8 top-32 bg-background/80 backdrop-blur-xl p-4 rounded-2xl border border-border/50 shadow-xl flex items-center gap-3">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="flex flex-col gap-32">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div className="order-2 md:order-1 relative aspect-[9/19.5] w-full max-w-[300px] mx-auto bg-black rounded-[2.5rem] p-2 shadow-2xl border-[3px] border-zinc-800">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative aspect-[9/19.5] w-full max-w-[300px] mx-auto bg-black rounded-[2.5rem] p-2 shadow-2xl border-[3px] border-zinc-800">
                <div className="relative w-full h-full rounded-[2rem] overflow-hidden bg-zinc-900">
