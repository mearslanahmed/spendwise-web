      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            ...
            <p className="text-base text-zinc-300 font-light leading-relaxed mb-6 flex-grow">&quot;Finally, a budgeting app that doesn&apos;t force me to hand over my bank credentials. Unlinked wallets are exactly what I&apos;ve been looking for. The UI is incredibly premium.&quot;</p>
            <div className="flex items-center gap-3">
